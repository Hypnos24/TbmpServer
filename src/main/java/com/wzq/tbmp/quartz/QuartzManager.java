...
import com.wzq.tbmp.quartz.job.TestTriggerJob;
...
public class QuartzManager {
   ...
   public static void addJob(String jobName,Job job,String time)   
       ...
       trigger.setTimeZone(DateUtil.getTimeZone());
   ...
   /**
	...
	public static void start() {
		try {
			addJob("test_job", new TestTriggerJob(), "0 0/1 * ? * *");
		} catch (Exception e) {
			//e.printStackTrace();
		}
	}
