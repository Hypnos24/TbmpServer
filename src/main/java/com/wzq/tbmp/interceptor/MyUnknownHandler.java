...
public class MyUnknownHandler implements UnknownHandler {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(MyUnknownHandler.class);
     ...
     */
    @Inject
    public MyUnknownHandler(Configuration configuration, ObjectFactory objectFactory,
