	...
	function vertifyFloat1(obj, defaltVal) {
	...
	function vertifyFloat2(obj, defaltVal) {
		var val = $(obj).val().trim();
		if (!isFloat(val)) {
			$(obj).val(defaltVal);
		}
	...
	function vertifyPositiveInteger1(obj, defaltVal) {
		var val = $(obj).val().trim();
	...
	function vertifyPositiveInteger2(obj, defaltVal) {
		var val = $(obj).val().trim();
