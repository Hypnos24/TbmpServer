				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<button class="btn btn-link" type="button" onclick="resetPass('${user.userId }');" data-toggle="button" data-loading-text="<i class='icon-refresh'></i>&nbsp;重置密码"><i class="icon-refresh"></i>&nbsp;重置密码</button>
						</td>
					</tr>
					</s:iterator>
				</tbody>
